...
|and(且)|true|false|flase|兩邊運算式為true，
|and(且)|false|true|false|才會回傳true
|and(且)|false|false|false|
|or(或)|true|true|true|
|or(或)|true|false|true|只要一邊運算式為true，
|or(或)|false|true|true|就會回傳true
|or(或)|false|false|false|
|not(否)|true|--|false|運算式反向
|not(否)|false|--|true|所得結果與原來相反
...
|:-:  |:-:    |:-:    |:-:|:-:|
|&(and)|1|1|1|
|&(and)|1|0|0|運算元1、運算元2的值皆為1，
|&(and)|0|1|0|才會回傳1
|&(and)|0|0|0|
|(Or)|1|1|1|
|(Or)|1|0|1|運算元1、運算元2的值有一個為1，
|(Or)|0|1|1|就會回傳1
|(Or)|0|0|0|
|^(Xor)|1|1|1|
|^(Xor)|1|0|1|運算元1、運算元2的值不同，
|^(Xor)|0|1|1|才會回傳1
|^(Xor)|0|0|0|
|~(not)|1|--|0|反向運算
|~(not)|0|--|1|將1變成0，將0變成1
